...
public class ToNekoArmorMaterials {
    ...
    public static void registerWithOutConfig() {
        NEKO = register(
                ...
                () -> Ingredient.of(TagKey.create(BuiltInRegistries.ITEM.key(), new ResourceLocation("c","wool"))), //wooooooooool
                0.5F, // 猫尾巴可以吸收什么伤害呢
    ...
    public static Holder<ArmorMaterial> register(
        ...
        List<ArmorMaterial.Layer> layers = List.of(
                ...
                new ArmorMaterial.Layer(new ResourceLocation(MODID, id), "", dyeable)
        );

        ArmorMaterial material = new ArmorMaterial(defensePoints, enchantability, equipSound, repairIngredientSupplier, layers, toughness, knockbackResistance);
        // Register the material within the ArmorMaterials registry.
        material = Registry.register(BuiltInRegistries.ARMOR_MATERIAL, new ResourceLocation(MODID, id), material);
